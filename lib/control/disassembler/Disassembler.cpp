...
control::Disassembler::Disassembler(QString inputFileName, QString architecture)
{
...
QString control::Disassembler::disassemble()
{
    // char buf[32];
...
{
    QString cmd = "";
    return QString::fromStdString(view::exec(cmd.toUtf8()));
}